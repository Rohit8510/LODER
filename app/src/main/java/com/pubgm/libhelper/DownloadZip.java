...
public class DownloadZip {
    ...
    //private final String ZIP_FILE_NAME = "GLOBAL.zip";
  //  private final String ZIP_FILE_NAME = "BGMI.zip";
    //private final String ZIP_FILE_NAME = "GODL.zip";
